  ...
  <section class="category-sec sec-padding">
    <div class="container">
      ...
      <div class="row row-cols-sm-2 row-cols-md-3 row-cols-xl-6 g-4">
        ...
        <a href="{{ route('course', $category->category_slug) }}" class="category-entry2 text-center" data-aos="fade" data-aos-delay="300">
          ...
          <h4 class="display-6 mt-3">{{ $category->category_name }}</h4>
        </a>
        @endforeach
      </div>
    </div>
